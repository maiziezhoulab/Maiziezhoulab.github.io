...
- **Interpretable spatial multi-omics data integration and dimension reduction with SpaMV.**  
  ...
  _Nature Communications_ (2026) 17:8213 [DOI](https://doi.org/10.1038/s41467-026-74718-1) 
...
- **ResGAT: A residual graph attention network for cancer subtype classification in whole slide images.**    
  **Z. Lin**, H. Tong, **Y. Hu**, X. S. Gui, J. Shen, B. Lee, L. Zhang, D. Moyer, M. Zhou, **X. M. Zhou\***, K. Votanopoulos\*.    
  _Proceedings of The 9th International Conference on Medical Imaging with Deep Learning_ (2026) PMLR 315:3911-3930. [DOI](https://proceedings.mlr.press/v315/lin26c.html)
...
- **stDyer-image improves clustering analysis of spatially resolved transcriptomics and proteomics with morphological images.**        
  K. Xu, **X. M. Zhou\***, L. Zhang*.  
   _Bioinformatics_ (2026) 42(3):btag071. [DOI](https://doi.org/10.1093/bioinformatics/btag071) 
...
- **FocalSV enables target region-based structural variant assembly and refinement using single-molecule long read sequencing data.**  
  **C. Luo**†, **Z. J. Zhou**†, **Y. H. Liu**, **X. M. Zhou**.  
  _Genome Research_ (2025) 35(10):2252-2272. [DOI](https://doi.org/10.1101/gr.280282.124)
